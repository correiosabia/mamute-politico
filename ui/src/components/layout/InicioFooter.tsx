...
function PartnerColumn({
  ...
  return (
    <div className="flex flex-col gap-2">
      <span className={partnerLabelClass}>{label}</span>
      {children}
    </div>
  );
}
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-6">
            <PartnerColumn label="Programa">
              <img
                src={logoCodesinfo}
                alt="Codesinfo"
                className="h-[44px] w-auto max-w-[176px] object-contain object-left"
              />
            </PartnerColumn>
            <PartnerColumn label="Apoio">
              <img
                src={logoProjor}
                alt="Projor"
                className="h-[39px] w-auto max-w-[161px] object-contain object-left"
              />
            </PartnerColumn>
            <PartnerColumn label="Financiamento">
              <img
                ...
                className="h-[31px] w-auto max-w-[215px] object-contain object-left"
              />
            </PartnerColumn>
          </div>
          <img
