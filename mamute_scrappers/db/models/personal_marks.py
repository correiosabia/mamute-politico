...
class ProjectMamutometro(Base):
    ...
    O SIGNIFICADO DE CADA NIVEL NAO EXISTE AQUI, o que mantém a tabela generica e livre. 
    A aplicacao do nivel e feita no front-end, que define o que significa cada nivel para o assinante.
